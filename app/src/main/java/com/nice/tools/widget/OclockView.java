...
public class OclockView extends View {
    ...
    public OclockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        weithColor = mode.getColorPrimary(getContext());
        grayColor = mode.getColorPrimary(getContext());
        ...
        sPaint = new Paint();
        sPaint.setColor(mode.getColorPrimary(getContext()));
        ...
        mPaint = new Paint();
        mPaint.setColor(mode.getColorPrimary(getContext()));
        mPaint.setStyle(Paint.Style.FILL);
        mPaint.setAntiAlias(true);

        hPaint = new Paint();
        hPaint.setColor(mode.getColorPrimary(getContext()));
