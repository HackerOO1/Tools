...
public class ChaosCompassView extends View{
    ...
    public ChaosCompassView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mDarkRedPaint.setColor(mode.getColorPrimary(getContext()));
        ...
        mTextPaint.setColor(mode.getColorPrimary(getContext()));

        //下面那个小三角指示符
        mCircumPaint = new Paint();
        mCircumPaint.setStyle(Paint.Style.FILL);
        mCircumPaint.setAntiAlias(true);
        mCircumPaint.setColor(mode.getColorPrimary(getContext()));
        ...
        mNorthPaint.setColor(mode.getColorPrimary(getContext()));
        ...
        mOthersPaint.setColor(mode.getColorPrimary(getContext()));
        ...
        mCenterPaint.setColor(mode.getColorPrimary(getContext()));
...
/*        mInnerPaint = new Paint();
        ...
        mAnglePaint.setColor(mode.getColorPrimary(getContext()));
