...
public class Daily_famliy_Activity extends AppCompatActivity {
    ...
    private void buttonEnable(Button button) {
        button.setTextColor(mode.getColorPrimary(this));
    ...
    private void initView() {
        //计数
        mode.jsphp(this,"famliy");

        tempCurrentRelative = new SqList(12);
        tempCurrentRelative.add("");
        mToolbar=findViewById(R.id.fam_toolbar);
        ...
        mEqualButton = findViewById(R.id.equal);
        mEachButton = findViewById(R.id.mutual_view);
        mFatherButton = findViewById(R.id.father);
        mMotherButton = findViewById(R.id.mother);
        mHusbandButton = findViewById(R.id.husband);
        mWifeButton = findViewById(R.id.wife);
        mOldBrotherButton = findViewById(R.id.old_bother);
        mLittleBrotherButton = findViewById(R.id.little_bother);
        mOldSisterButton = findViewById(R.id.old_sister);
        mLittleSisterButton = findViewById(R.id.little_sister);
        mSonButton = findViewById(R.id.son);
        mDaughterButton = findViewById(R.id.daughter);
